...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex flex-col space-y-1.5 p-6 border-b border-border/50 bg-secondary/20", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "text-lg font-bold leading-none tracking-widest uppercase text-primary glow-text",
      className
    )}
    {...props}
  />
